                                ...
                                experieceState.map((exp, index) => {
                                    return <div>
                                        ...
                                        <HorizontalCard onClick={() => setHidden(exp.id)}>
                                            ...
                                            {
                                                <ul className={`list-disc px-3 flex flex-col gap-2 text-mute ${exp.hidden ? "hidden" : ""}`}>
                                                    {
                                            ...
                                            <a className='cursor-pointer flex items-center gap-1 text-[15px] text-mute/80' onClick={() => setHidden(exp.id)}>
                                                ...
                                                <i className={`fa-solid fa-chevron-down ${exp.hidden ? "rotate-0" : " -rotate-180"} transition-all`}></i>
                                            </a>
