...
const NavModalMobile = ({ hiddenNavMovile, reDirection }: NavModalMobileTypeHidden) => {
    ...
    return ( 
        <div className={`${classIsHidden} fixed right-5 top-16 p-5 bg-black/80 backdrop-blur-3xl rounded-lg  transition-all duration-80 z-50 border-2 border-zinc-700/60`}>
